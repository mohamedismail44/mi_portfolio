        ...
        <table className="w-full lg:text-xl text-left border-collapse">
          <thead className="capitalize bg-slate-700 text-white">
            <tr>
              ...
              <th className="border border-gray-500 lg:p-3 text-center">Name</th>
              <th className="border border-gray-500 lg:p-3 text-center">Email</th>
              <th className="border border-gray-500 lg:p-3 text-center">Subject</th>
              <th className="border border-gray-500 lg:p-3 text-center">Message</th>
            </tr>
          </thead>
          <tbody>
            {data.map((post, index) => (
              <tr key={post?.id} className="even:bg-slate-200 odd:bg-white hover:bg-slate-300">
                ...
                <td className="p-1 border border-gray-500 text-center">
                  <span className="line-clamp-2">{post?.subject}</span>
                </td>
                <td className="p-1 border border-gray-500 text-center">
